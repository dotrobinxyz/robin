...
// Vendored verbatim from daimo-eth/p256-verifier (MIT); only the pragma and
// import paths changed. See the original for the full list of WebAuthn
// assertion steps this library does and does not verify.
